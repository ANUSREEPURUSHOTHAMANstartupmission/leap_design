<script>
  ...
  <svelte:window bind:scrollY={y}/>
   ...
   flex sm:items-center
    ...
    z-50  py-2
           {scrolled ? 'bg-white top-0' : 'bg-transparent sm:top-14'}
    ...
    <div class="w-full container mx-auto  flex justify-between px-4">
     ...
     <main class=" flex  items-start px-7 my-auto">
        <div style="font-family: Museo-Sans, sans-serif;" class="flex my-auto  {scrolled?'text-black':'text-black'}">
            ...
            <a href="/#conclave"  class="md:flex cursor-pointer hidden px-4 py-3  md:py-1 uppercase   text-sm">MICROBIOME CONCLAVE</a>
            <a href="/#ideathon"  class="md:flex cursor-pointer hidden px-4 py-3  md:py-1 uppercase   text-sm">MICROBIOME IDEATHON
            </a>
