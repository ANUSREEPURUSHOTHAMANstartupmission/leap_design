                                    ...
                                    <div class="inner-heading-wrap flex-two">
                                        <div class="inner-heading">
                                            ...
                                            <ul class="flex-three list-wrap-heading gap-3">
                                                <li class="flex-three">
                                                    <i class="icon-18"></i>
                                                    <span class="md:text-base sm:text-[12px] text-[10px] text-black">{item.address}</span>
                                                </li>
                                                <li class="flex-three text-[#00AEEF;] gap-3">
                                                    ...
                                                    <span class="md:text-base sm:text-[12px] text-[10px] text-black">{item.email}</span>
                                                </li>
                                                <li class="flex-three text-[#00AEEF;] gap-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                    ...
                                                    <span class="md:text-base sm:text-[12px] text-[10px] text-black">{item.number}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
